...
function At(e, t = "") {
  return ["opacity", "z-index", "line-height", "font-weight", "flex", "flex-grow", "flex-shrink", "order"].some((s3) => t.endsWith(s3)) ? e : `${e}`.trim().split(" ").map((a2) => z2(a2) ? `${a2}px` : a2).join(" ");
}
function dt(e) {
...
//# sourceMappingURL=chunk-XHEYY3OD.js.map
